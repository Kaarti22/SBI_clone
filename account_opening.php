...
<link rel="stylesheet" href="account_opening_style.css">
</head>
<body>
    ...
    <div class="main-section">
        <div class="container">
            ...
            <h3> Customer Name is : <?php  echo $cust_name; ?></h3>
            <h3> Address of Customer is : <?php  echo $addr; ?></h3>
            <h3> Customer city is : <?php  echo $city; ?></h3>
        </div>
    </div>
