...
<body>
    <header>
        ...
        <div class="panel">
            ...
            <div class="panel-options">
                ...
                <img class="panel-img loans" src="loans.png"><a class="accounts_login" href="front.php">Account Deletion</a></div>
            <div class="panel-options">
    ...
    <div class="main-section">
        <div class="dep_borr">
            ...
            echo '<table align=\"left\" border="1"><tr><th>Name</th><th>A/C No.</th><th> Balance</th><th>Details</th></tr>';
            while($result = mysqli_fetch_assoc($res)){
                echo '<tr><td>'. $result['customer_name'].'</td><td>'.$result['account_number'].'</td><td>'.$result['balance'].'</td><td><a href = "account_opening.php?username='.$result['customer_name'].'">View Details</a></td></tr>';
            }
            echo '</table>';
            ?>
        ...
        <div class="dep_borr">
            ...
            $res = mysqli_query($connection, $sql);
            echo '<table align=\"right\" border="1"><tr><th>Name</th><th>A/C No.</th><th> Balance</th><th>Details</th></tr>';
            while($result = mysqli_fetch_assoc($res)){
                echo '<tr><td>'. $result['customer_name'].'</td><td>'.$result['loan_number'].'</td><td>'.$result['amount'].'</td><td><a href = "account_opening.php?username='.$result['customer_name'].'">View Details</a></td></tr>';
            }
            echo '</table>';
            ?>
